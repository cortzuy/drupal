<?php
namespace Drupal\uy_page\Controller;

use Drupal\Core\Controller\ControllerBase;
use Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException;
use Drupal\uy_page\Utility\DescriptionTemplateTrait;

class UyPageController extends ControllerBase {
    ...
    public function arguments($first, $second){
        ...
        $render_array['uy_page_arguments'] = [
